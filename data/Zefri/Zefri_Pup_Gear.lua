...
function user_job_setup()
	...
	state.PetMode = M{['description']='Pet Mode', 'None','Melee','Ranged','HybridRanged','Bruiser','Tank','LightTank','Magic','Heal','Nuke','Overdrive'}
...
function init_gear_sets()
	...
	body=gear.taeon_FC_body,ring1="Weather. Ring +1",
	legs="Gyve Trousers"}
	...
	sets.midcast.Pet.PetWSGear.Bruiser = set_combine(sets.midcast.Pet.PetWSGear, {ear1="Domesticator's Earring",ear2="Burana Earring",})
	...
	sets.midcast.Pet.PetEnmityGear = {
        head="Heyoka Cap",ear1="Rimeice Earring",ear2="Domesticator's Earring",
        body="Heyoka Harness",hands="Heyoka Mittens",
        back=gear.tank_jse_back,legs="Heyoka Subligar",feet="Heyoka Leggings"}
    ...
    sets.idle = {main="Ohtas",
        ...
        body="Pitre Tobe +3",hands="Tali'ah Gages +2",ring1="Defending Ring",ring2="Gelatinous Ring +1",
    ...
    sets.idle.Pet = {main="Midnights",
        ...
        body=gear.taeon_pet_body,hands=gear.taeon_pet_hands,ring1="Defending Ring",ring2="Gelatinous Ring +1",
	...
	sets.idle.Pet.Engaged.Tank = set_combine(sets.idle.Pet.Engaged, {main="Midnights",
        head="Anwig Salade",neck="Loricate Torque +1",ear1="Enmerkar Earring",ear2="Rimeice Earring",
        body=gear.taeon_pet_body,hands=gear.taeon_pet_hands,ring1="Varar Ring",ring2="Varar Ring",
        back=gear.tank_jse_back,waist="Isa Belt",legs="Tali'ah Sera. +2",feet=gear.taeon_pet_feet})
	sets.idle.Pet.Engaged.Bruiser = set_combine(sets.idle.Pet.Engaged, {main="Midnights",
        head="Anwig Salade",neck="Loricate Torque +1",ear1="Enmerkar Earring",ear2="Rimeice Earring",
        body=gear.taeon_pet_body,hands=gear.taeon_pet_hands,ring1="Varar Ring",ring2="Varar Ring",
        back=gear.tank_jse_back,waist="Isa Belt",legs="Tali'ah Sera. +2",feet=gear.taeon_pet_feet})
	sets.idle.Pet.Engaged.LightTank = set_combine(sets.idle.Pet.Engaged, {main="Midnights",
        head="Anwig Salade",neck="Loricate Torque +1",ear1="Enmerkar Earring",ear2="Rimeice Earring",
        body=gear.taeon_pet_body,hands=gear.taeon_pet_hands,ring1="Varar Ring",ring2="Varar Ring",
        back=gear.tank_jse_back,waist="Isa Belt",legs="Tali'ah Sera. +2",feet=gear.taeon_pet_feet})
    ...
    sets.idle.Pet.Engaged.DT = {main="Midnights",
        head="Anwig Salade",neck="Loricate Torque +1",ear1="Enmerkar Earring",ear2="Rimeice Earring",
        body=gear.taeon_pet_body,hands=gear.taeon_pet_hands,ring1="Defending Ring",ring2="Gelatinous Ring +1",
        back=gear.tank_jse_back,waist="Isa Belt",legs="Tali'ah Sera. +2",feet=gear.taeon_pet_feet}
    ...
    sets.defense.PDT = {main="Ohtas",
        ...
        back="Mecisto. Mantle",legs="Malignance Tights",feet="Malignance Boots"}
 ...
 --       back=gear.haste_jse_back,waist="Windbuffet Belt +1",legs="Ryuo Hakama",feet=gear.herculean_ta_feet}
        head="Malignance Chapeau",neck="Shulmanu Collar",ear1="Telos Earring",ear2="Brutal Earring",
        body="Malignance Tabard",hands="Malignance Gloves",ring1="Niqmaddu Ring",ring2="Epona's Ring",
        back=gear.tp_jse_back,waist="Yemaya Belt",legs="Malignance Tights",feet="Malignance Boots"}
    sets.engaged.Acc = {main="Ohtas",
        head="Malignance Chapeau",neck="Shulmanu Collar",ear1="Telos Earring",ear2="Brutal Earring",
        body="Malignance Tabard",hands="Malignance Gloves",ring1="Niqmaddu Ring",ring2="Epona's Ring",
        back=gear.tp_jse_back,waist="Yemaya Belt",legs="Malignance Tights",feet="Malignance Boots"}
    sets.engaged.FullAcc = {main="Ohtas",
        head="Malignance Chapeau",neck="Shulmanu Collar",ear1="Telos Earring",ear2="Brutal Earring",
        body="Malignance Tabard",hands="Malignance Gloves",ring1="Niqmaddu Ring",ring2="Epona's Ring",
        back=gear.tp_jse_back,waist="Yemaya Belt",legs="Malignance Tights",feet="Malignance Boots"}
	sets.engaged.Fodder = {main="Ohtas",
        head="Malignance Chapeau",neck="Shulmanu Collar",ear1="Telos Earring",ear2="Brutal Earring",
        body="Malignance Tabard",hands="Malignance Gloves",ring1="Niqmaddu Ring",ring2="Epona's Ring",
        back=gear.tp_jse_back,waist="Yemaya Belt",legs="Malignance Tights",feet="Malignance Boots"}
